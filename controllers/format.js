                                    ...
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="column"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 10px; padding-right: 10px; padding-top: 5px; padding-bottom: 15px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                        width="100%">
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <div align="center" style="line-height:10px">
                                                                        <img alt="Main Image"
                                                                            src="https://i.postimg.cc/g06ygJ8c/Fair-Trader-logo.png"
                                                                            style="display: block; height: auto; border: 0;;margin-top: 120px !important; width: 232px; max-width: 100%;"
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div align="center">
                                                                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com/" style="height:42px;width:217px;v-text-anchor:middle;" arcsize="58%" stroke="false" fillcolor="#ffffff"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#091548; font-family:sans-serif; font-size:15px"><![endif]--><a
                                                                            href='https://www.fairtradingpost.org/resetpassword?token=${token}&email=${email}'
